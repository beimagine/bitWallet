    ...
    return (
        <div className="Dsection">
            ...
            <div className="buttons">
                <a href={'https://apps.apple.com/in/app/be-imagine-technology-wallet/id6443855034'} target="blank" rel="noopener noreferrer">
                ...
                <a href={'https://play.google.com/store/apps/details?id=beimagine.tech&pli=1'} target="blank" rel="noopener noreferrer">
            ...
            <a href={'https://chrome.google.com/webstore/detail/bitwallet/ddphokhghjkekfdoddpeffdpojdofcan'} target="blank" rel="noopener noreferrer">
