    ...
    return (<>
        <div className="vision">
            <div className="vision-text">
                ...
                <p className="para"> Enhance your user experience with <br></br> <span className="bitword2"> BitWallet</span>, the key to the blockchain world.</p>
        ...
        <Slide direction="up" triggerOnce easing="ease-in-out" duration={2000}>
        ...
        <div className="walletContent2">
            ...
            <div className="walletInfo2">
                ...
                <p>BitWallet generates passwords and keys on your device, ensuring that only you have access to your accounts and data. It provides assistance in navigating through various decentralized websites and blockchain apps.</p>
            </div>
        </div>
        </Slide>
        ...
        <div className="walletContent3">
            ...
            <div className="walletInfo3">
                <p>The Web3 and blockchain revolution are ushering in an era of continuous and secure digital operations, eliminating downtime and transforming the landscape of online systems.</p>
